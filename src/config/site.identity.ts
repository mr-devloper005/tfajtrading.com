export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'tfajtrading',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Tfajtrading',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'tfajtrading.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://tfajtrading.com',
